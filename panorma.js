import { S as E, P as S } from "./vendorr.js";
const $ = function () {
    const s = document.createElement("link").relList;
    if (s && s.supports && s.supports("modulepreload")) return;
    for (const e of document.querySelectorAll('link[rel="modulepreload"]')) r(e);
    new MutationObserver((e) => {
        for (const t of e) if (t.type === "childList") for (const n of t.addedNodes) n.tagName === "LINK" && n.rel === "modulepreload" && r(n);
...
new E(".panorama-slider .swiper", {
    ...
    grabCursor: !0,
   autoplay:true,
    pagination: { el: ".swiper-pagination", dynamicBullets: !0, dynamicMainBullets: 3 },
